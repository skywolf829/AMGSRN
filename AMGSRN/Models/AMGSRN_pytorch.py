...
class AMGSRN_old(nn.Module):
    def __init__(self, opt):
        super(AMGSRN_old, self).__init__()
        ...
        self.encoder = AMG_encoder_old(opt['n_grids'], opt['n_features'] , 
